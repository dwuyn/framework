...
LABEL org.opencontainers.image.title="VulnBot" \
      com.veriplanpt.framework="VulnBot" \
...
ENV PATH="/opt/venv/bin:$PATH" PYTHONPATH="/opt/upstream" VERIPLANPT_SOURCE_DIR="/opt/upstream" VERIPLANPT_RUN_DIR="/run/veriplanpt"
...
CMD ["python", "cli.py", "vulnbot", "--max_interactions", "1"]
