...
def validate_training_protocol(
    ...
    if strict_runtime:
        ...
        if protocol.get("runtime_contract") in {"veriplanpt-runtime-v0.4.0-r10.3", "veriplanpt-runtime-v0.4.0-r10.4", "veriplanpt-runtime-v0.4.0-r10.6"} and (
        ...
        r10 = protocol.get("runtime_contract") in {"veriplanpt-runtime-v0.4.0-r10.3", "veriplanpt-runtime-v0.4.0-r10.4", "veriplanpt-runtime-v0.4.0-r10.6"}
        for item in profiles:
